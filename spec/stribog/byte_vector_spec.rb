...
describe Stribog::ByteVector do
  ...
  context 'create vector' do
    ...
    it 'does return convert instance correct' do
  ...
  context '#+' do
    it 'does return new vector contains concatenation of two' do
  ...
  context '#^' do
    it 'does return new vector contains xor of two' do
  ...
  context '#addition' do
    ...
    it 'does return new vector addition by zeros' do
  ...
  context '#padding' do
    ...
    it 'does return new vector addition by padding' do
