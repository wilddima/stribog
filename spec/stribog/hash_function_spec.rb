...
describe Stribog::CreateHash do
  context '256 bit hash, with 504 bit message' do
    context 'correct message and correct hash' do
      ...
      it 'should has correct hash' do
        expect(q.(256).to_hex).to eq('557be5e584fd52a449b16b0251d05d27f94ab76cbaa6da890b59d8ef1e159d')
      end
    end
    ...
    context 'incorrect message and incorrect hash' do
      ...
      q = Stribog::CreateHash.new(message)
      it 'should has correct hash' do
        expect(q.(256).to_hex).not_to eq('557be5e584fd52a449b16b0251d05d27f94ab76cbaa6da890b59d8ef1e159d')
      end
    end
  end
  ...
  context '256 bit hash, with 576 bit message' do
    context 'correct message and correct hash' do
      ...
      q = Stribog::CreateHash.new(message)
      it 'should has correct hash' do
        expect(q.(256).to_hex).to eq('508f7e553c06501d749a66fc28c6cac0b005746d97537fa85d9e40904efed29d')
      end
    end
    ...
    context 'incorrect message and incorrect hash' do
      ...
      q = Stribog::CreateHash.new(message)
      it 'should has correct hash' do
        expect(q.(256).to_hex).not_to eq('508f7e553c06501d749a66fc28c6cac0b005746d97537fa85d9e40904efed29d')
      end
    end
  end
  ...
  context '512 bit hash, with 504 bit message' do
    context 'correct message and correct hash' do
      ...
      q = Stribog::CreateHash.new(message)
      it 'should has correct hash' do
        expect(q.(512).to_hex).to eq('486f64c1917879417fef082b3381a4e211c324f074654c38823a7b76f830ad00fa1fbae42b1285c0352f227524bc9ab16254288dd6863dccd5b9f54a1ad0541b')
      end
    end
    ...
    context 'incorrect message and incorrect hash' do
      ...
      q = Stribog::CreateHash.new(message)
      it 'should has correct hash' do
        expect(q.(512).to_hex).not_to eq('486f64c1917879417fef082b3381a4e211c324f074654c38823a7b76f830ad00fa1fbae42b1285c0352f227524bc9ab16254288dd6863dccd5b9f54a1ad0541b')
      end
    end
  end
  ...
  context '512 bit hash, with 576 bit message' do
    context 'correct message and correct hash' do
      ...
      q = Stribog::CreateHash.new(message)
      it 'should has correct hash' do
        expect(q.(512).to_hex).to eq('28fbc9bada033b1460642bdcddb90c3fb3e56c497ccd0f62b8a2ad4935e85f037613966de4ee00531ae60f3b5a47f8dae06915d5f2f194996fcabf2622e6881e')
      end
    end
    ...
    context 'incorrect message and incorrect hash' do
      ...
      q = Stribog::CreateHash.new(message)
      it 'should has correct hash' do
        expect(q.(512).to_hex).not_to eq('28fbc9bada033b1460642bdcddb90c3fb3e56c497ccd0f62b8a2ad4935e85f037613966de4ee00531ae60f3b5a47f8dae06915d5f2f194996fcabf2622e6881e')
      end
    end
  end
  ...
  context '1000 bytes message' do
    ...
    it 'should has correct hash 256 bit' do
      expect(q.(256).to_hex).to eq('ecb9740fe86431761b774916ad420fee0beb422cf714640a8f962343c8b88476')
    end

    it 'should has correct hash 512 bit' do
      expect(q.(512).to_hex).to eq('7d99e2c04f74519c793cbc5ca06239b2600c62ffe74ef275a13e895da83c4f396135e0b73a140f0246d0414dd2e2f3fbca30093e73106f74d3eeb9873af4dfe8')
    end
  end
end